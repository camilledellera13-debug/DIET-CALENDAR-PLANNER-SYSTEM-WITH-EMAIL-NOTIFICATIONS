...
def init_database():
    """Initialize database with schema from your db.sql structure"""
    conn = get_db_connection()
    cursor = conn.cursor()

    # Create users table (matching your user table from db.sql)
    cursor.execute('''
    ...
    # Create mealfood table (junction table)
    cursor.execute('''
    ...
    # Create activities table (for the new feature)
    cursor.execute('''
    ...
    # Insert sample data from your db.sql
...
def insert_sample_data(cursor):
    """Insert sample data from your db.sql file"""

    # Insert sample users (passwords are hashed - in production use proper hashing)
    cursor.execute('''
    ...
    # Insert sample meal-food relationships
    cursor.execute('''
...
def migrate_existing_db():
    """Function to migrate existing schema.db to new structure"""
